...
The id of a location. This is either an area id or a map id based on the value of link_kind. See "AreaTable.dbc":AreaTable.dbc

h4. link&#95;kind

The kind of id, either GRAVEYARD_AREALINK = 0 or GRAVEYARD_MAPLINK = 1
