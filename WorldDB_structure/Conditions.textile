...
|41|CONDITION_GENDER_NPC|Checks the gender of a NPC|
...
** value1: NPC gender from SharedDefines.h enum Gender (0:male, 1:female, 2:none)
Condition returns true if source NPC model has gender equal to value1. Model gender is defined in creature_model_info.gender