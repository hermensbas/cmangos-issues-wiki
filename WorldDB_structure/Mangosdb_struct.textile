...
|(Deprecated) "creature_ai_texts":https://github.com/cmangos/issues/wiki/creature_ai_texts|See "broadcast_text":https://github.com/cmangos/issues/wiki/broadcast_text|
...
|(Deprecated) "dbscript_string":https://github.com/cmangos/issues/wiki/dbscript_string|See "broadcast_text":https://github.com/cmangos/issues/wiki/broadcast_text|
...
|"item_expire_convert":https://github.com/cmangos/issues/wiki/item_expire_convert (Reloadable) (Core)|contains pairs of times which turn into an other item after a certain amount of time.|
...
|"locals_areatrigger_teleport":https://github.com/cmangos/issues/wiki/locals_areatrigger_teleport|?|
...
|"mail_template_dbc":https://github.com/cmangos/issues/wiki/mail_template_dbc|?|
...
|"player_classlevelstats":https://github.com/cmangos/issues/wiki/player_classlevelstats (Core)|holds information on the base health and mana of characters when they level up. Each class has different level stats.|
|"player_levelstats":https://github.com/cmangos/issues/wiki/player_levelstats (Core)|holds information on the base health and mana of characters when they level up. Each class has different level stats.|
|"player_xp_for_level":https://github.com/cmangos/issues/wiki/player_xp_for_level (Core)|includes information on how much experience needed for next level. Comes from sniffs.|
|"playercreateinfo":https://github.com/cmangos/issues/wiki/playercreateinfo (Core)|holds the start positions of each class-race combinations for all newly created characters.|
|"playercreateinfo_action":https://github.com/cmangos/issues/wiki/playercreateinfo_action (Core)|holds information on what default actions a brand new character should start out with.|
|"playercreateinfo_item":https://github.com/cmangos/issues/wiki/playercreateinfo_item (Core)|holds information on what items each race-class combination of a new character starts out with.|
|"playercreateinfo_skills":https://github.com/cmangos/issues/wiki/playercreateinfo_skills (Core)|holds information on what skills newly created characters should start out with.|
|"playercreateinfo_spell":https://github.com/cmangos/issues/wiki/playercreateinfo_spell (Core)|holds information on what spells newly created characters should start out with.|
...
|"spawn_group":https://github.com/cmangos/issues/wiki/spawn_group|Defines how groups of entities spawn|
...
|"spell_bonus_data":https://github.com/cmangos/issues/wiki/spell_bonus_data (Reloadable)|is used for storing custom damage/healing bonus coefficients.|
...
|"warden_scans":https://github.com/cmangos/issues/wiki/warden_scans|?|
