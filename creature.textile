...
|"modelid":creature#modelid|mediumint(8) unsigned|YES||0|Dont use if possible|
|"equipment_id":creature#equipment_id|mediumint(9)|NO||0|Dont use if possible|
...
|"curhealth":creature#curhealth|int(10) unsigned|NO||1|Deprecated Dont Use|
|"curmana":creature#curmana|int(10) unsigned|NO||0|Deprecated Dont Use|
|"DeathState":creature#deathstate|tinyint(3) unsigned|NO||0|Deprecated Dont Use|
