...
The minimum respawn time of the creature in seconds. If 0 creature will not respawn, only scripted respawn

h4. spawntimesecsmax

The maximum respawn time of the creature in seconds. If 0 creature will not respawn, only scripted respawn
