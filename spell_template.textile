...
Determines the default targets for some spells. These specify what needs to be supplied to a spell/effect and some are used for client->server sending and some for server->client sending.

|*Id*|*Enum name*|*Comment*|
| 0| TARGET_FLAG_SELF| No data supplied or being sent |
| 1| TARGET_FLAG_UNUSED1|         |
| 4| TARGET_FLAG_UNIT|   |
| 8| TARGET_FLAG_UNIT_RAID|        |
|10| TARGET_FLAG_UNIT_PARTY|      |
|20| TARGET_FLAG_ITEM|          |
|40| TARGET_FLAG_SOURCE_LOCATION|        |
|80| TARGET_FLAG_DEST_LOCATION|          |
|100| TARGET_FLAG_UNIT_ENEMY||
|200| TARGET_FLAG_UNIT_ALLY|       |
|400| TARGET_FLAG_CORPSE_ENEMY|         |
|800| TARGET_FLAG_UNIT_DEAD|         |
|1000| TARGET_FLAG_GAMEOBJECT|          |
|2000| TARGET_FLAG_TRADE_ITEM| Item you would like enchanted in trade for example |
|4000| TARGET_FLAG_STRING|      |
|8000| TARGET_FLAG_LOCKED| Item or GameObject |
|10000| TARGET_FLAG_CORPSE_ALLY|       |
|20000| TARGET_FLAG_UNIT_MINIPET| Critter pet |
