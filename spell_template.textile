...
||"EffectMechanic{1,2,3}":spell_template#effectmechanicN|INT(11) UNSIGNED|NO||0||
||"EffectImplicitTargetA{1,2,3}":spell_template#effectimplicittargetaN|INT(11) UNSIGNED|NO||0||
||"EffectImplicitTargetB{1,2,3}":spell_template#effectimplicittargetbN|INT(11) UNSIGNED|NO||0||
...
From TBC onwards, spells can have multiple schools. Best example is either Fel Lightning in Magisters Terrace or Frostfire bolt WOTLK mage spell
