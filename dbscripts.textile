...
** dataint - dataint4: The text ID that the creature will say. See "dbscript_string.":dbscript_string.In case more then only dataint field is filled the texts will be used randomly.

* *SCRIPT_COMMAND_EMOTE = 1*
** datalong: The "emote ID":Emote to play.
** dataint - dataint4 optionally, for random selection of emote
