...
* *Other Ways to launch dbscripts* 
   ...
   ** For creature_ai_scripts - ACTION_T_TEXT_NEW.param3 to launch dbscript_random_templates.type = 0, "broadcast_text":broadcast_text#id
   ** For creature_ai_scripts - ACTION_T_START_RELAY_SCRIPT to launch type = 2, dbscripts_on_relay
	
   ** For SCRIPT_COMMAND_TALK to launch dbscript_random_templates.type = 0, "broadcast_text":broadcast_text#id
...
** dataint2 = factionId - if 0 is set, faction is from DB entry - *Deprecated, Do not use*
** dataint3 = modelId - if 0 is set, model is from DB entry - *Deprecated, Do not use*
