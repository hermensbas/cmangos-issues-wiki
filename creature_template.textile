...
|"StaticFlags1":creature_template#staticflags1|int(10) unsigned|YES||0||
|"StaticFlags2":creature_template#staticflags2|int(10) unsigned|YES||0||
|"StaticFlags3":creature_template#staticflags3|int(10) unsigned|YES||0||
|"StaticFlags4":creature_template#staticflags4|int(10) unsigned|YES||0||
...
|32|0x00000020|CREATURE_EXTRA_FLAG_UNUSED||
|64|0x00000040|CREATURE_EXTRA_FLAG_UNUSED2||
|128|0x00000080|CREATURE_EXTRA_FLAG_INVISIBLE|creature is always invisible for player (mostly trigger creatures)|
|256|0x00000100|CREATURE_EXTRA_FLAG_UNUSED3||
...
|134217728|CREATURE_TYPEFLAGS_FORCE_GOSSIP|WoTLK ONLY - Allows the creature to display a single gossip option.|
...
h4. InteractionPauseTimer

WaitTime in Milliseconds befor npc resumes pathing after being talked to
...
Sets "StringId":https://github.com/cmangos/issues/wiki/string_id#id to all creature spawns with entry
