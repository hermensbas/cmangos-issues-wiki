...
|"Faction":creature_template_classic#faction|smallint(5) unsigned|NO||0||
...
|"StaticFlags1":creature_template_classic#staticflags1|int(10) unsigned|YES||0||
|"StaticFlags2":creature_template_classic#staticflags2|int(10) unsigned|YES||0||
|"StaticFlags3":creature_template_classic#staticflags3|int(10) unsigned|YES||0||
|"StaticFlags4":creature_template_classic#staticflags4|int(10) unsigned|YES||0||
|"SpeedWalk":creature_template_classic#speedwalk|float|YES||1||
|"SpeedRun":creature_template_classic#speedrun|float|YES||1.14286||
|"Detection":creature_template_classic#detection|int|NO||20||
|"CallForHelp":creature_template_classic#callforhelp|int|NO||0||
|"Pursuit":creature_template_classic#pursuit|int|NO||0||
|"Leash":creature_template_classic#leash|int|NO||0||
|"Timeout":creature_template_classic#timeout|int|NO||0||
...
|"InteractionPauseTimer	":creature_template_classic#InteractionPauseTimer|int(10) unsigned|NO||-1|Waittimer befor npc resumes pathing after being talked to|
|"VisibilityDistanceType":creature_template_classic#visibilityDistanceType|tinyint(4)|YES||0||
|"CorpseDecay":creature_template_classic#CorpseDecay|int(10) unsigned|NO||0||
|"SpellList":creature_template_classic#SpellList|int(11)|NO||0|"creature_spell_list":https://github.com/cmangos/issues/wiki/creature_spell_list|
...
This is the Primary NPC Entry Number for everything in classic-db, as neither HeroicEntry nor DifficultyEntry exist in classic. (No need for "`creature`.`SpawnMask`":creature#SpawnMask
...
|0x00000004|4|UNIT_NPC_FLAG_VENDOR|*TBC+ uses 128* - Any creature selling items needs to have this flag.|
|0x00000008|8|UNIT_NPC_FLAG_FLIGHTMASTER|*TBC+ uses 8192* - Any creature serving as fly master has this.|
|0x00000010|16|UNIT_NPC_FLAG_TRAINER|Allows the creature to have a trainer list to teach spells|
|0x00000020|32|UNIT_NPC_FLAG_SPIRITHEALER|*TBC+ uses 16384* - Makes the creature invisible to alive characters and has the resurrect function.|
|0x00000040|64|UNIT_NPC_FLAG_SPIRITGUIDE|*TBC+ uses 32768*|
|0x00000080|128|UNIT_NPC_FLAG_INNKEEPER|*TBC+ uses 65536* - Creatures with this flag can set hearthstone locations.|
|0x00000100|256|UNIT_NPC_FLAG_BANKER|*TBC+ uses 131072* - Creatures with this flag can show the bank|
|0x00000200|512|UNIT_NPC_FLAG_PETITIONER|*TBC+ uses 262144* - guild petitions|
|0x00000400|1024|UNIT_NPC_FLAG_TABARDDESIGNER|*TBC+ uses 524288* - Allows the designing of guild tabards.|
|0x00000800|2048|UNIT_NPC_FLAG_BATTLEMASTER|*TBC+ uses 1048576* - Creatures with this flag port players to battlegrounds.|
|0x00001000|4096|UNIT_NPC_FLAG_AUCTIONEER|*TBC+ uses 2097152* - Allows creature to display auction list.|
|0x00002000|8192|UNIT_NPC_FLAG_STABLEMASTER|*TBC+ uses 4194304* - Has the option to stable pets for hunters.|
|0x00004000|16384|UNIT_NPC_FLAG_REPAIR|*TBC+ uses 4096* - Creatures with this flag can repair items.|
|0x20000000|536870912|UNIT_NPC_FLAG_OUTDOORPVP|Custom flag! - for outdoor pvp creatures|
...
|0x00000010|16|UNIT_FLAG_PET_RENAME|Old pet rename: moved to UNIT_FIELD_BYTES_2,2 in TBC+|
|0x00000020|32|UNIT_FLAG_PET_ABANDON|Old pet abandon: moved to UNIT_FIELD_BYTES_2,2 in TBC+|
...
|0x08000000|134217728|UNIT_FLAG_AURAS_VISIBLE|magic detect|
