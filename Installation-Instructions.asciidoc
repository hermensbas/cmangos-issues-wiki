 ...
 * https://tracker.iplocation.net/hmfm[Git] - Ensure the "Windows Explorer Integration - Git Bash Here" option is enabled on the "Select Components" page of the install wizard in order to follow along with these instructions. The default options should be fine otherwise. __Alternatively, you can install (http://sourceforge.net/projects/gitextensions/files/latest/download)[Git Extensions] instead, which comes with Git, MySYSGit, and KDiff).__
...
- Go to https://tracker.iplocation.net/hmfo[https://sourceforge.net/projects/boost/files/boost-binaries]
...
|======================
|         |Win32                         |x64
|VS 2015  |https://tracker.iplocation.net/hmfq[boost_x_xx_x-msvc-14.0-32.exe] |https://tracker.iplocation.net/hmfq[boost_x_xx_x-msvc-14.0-64.exe]
|VS 2017  |https://tracker.iplocation.net/hmfq[boost_x_xx_x-msvc-14.1-32.exe] |https://tracker.iplocation.net/hmfq[boost_x_xx_x-msvc-14.1-64.exe]
|======================
...
* https://tracker.iplocation.net/hmft[Classic Server Release]
* https://github.com/cmangos/mangos-tbc/releases/tag/Last_mangos-tbc_PreBuild[TBC Server Release]
* https://tracker.iplocation.net/hmft[WotLK Server Release]
