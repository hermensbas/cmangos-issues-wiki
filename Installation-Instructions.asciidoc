...
```
Note: You'll need to add cmake to https://www.architectryan.com/2018/03/17/add-to-the-path-on-windows-10/[PATH] after installing. Default install location is `C:\Program Files\CMake\bin`.
