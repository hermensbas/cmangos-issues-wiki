...
This guide will help you for Windows, *nix (Ubuntu, Debian), and MacOS (11.1) (**in progress**), and for all supported clients: Classic - TBC - WotLK.
...
On *nix and MacOS you may want to use the following two scripted commands:
