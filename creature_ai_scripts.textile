...
|17|TARGET_T_NEAREST_AOE_TARGET|Checks for available near aoe targets by <code>EffectRadiusIndex[0]</code> for the spell used|
...
|3|TYPE_NO_MELEE_MODE|No Melee, No Chase|
