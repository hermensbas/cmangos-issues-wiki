...
All variables are enum class UnitCondition:  
    ...
    NUMBER_OF_MELEE_ATTACKERS                = 37, Result:
    IS_ATTACKING_ME                          = 38, Result: 1 if
    RANGE                                    = 39, Result:
    IN_MELEE_RANGE                           = 40, Result:
    PURSUIT_TIME                             = 41, Result: NYI - Notify should it be needed
    HAS_HARMFUL_AURA_CANCELLED_BY_DAMAGE     = 42, Result:
    HAS_HARMFUL_AURA_WITH_PERIODIC_DAMAGE    = 43, Result:
    NUMBER_OF_ENEMIES                        = 44, Result:
    NUMBER_OF_FRIENDS                        = 45, Result:
    ...
    NUMBER_OF_ATTACKERS                      = 54, Result:
    NUMBER_OF_RANGED_ATTACKERS               = 55, Result:
    CREATURE_TYPE                            = 56, Result:
    IS_MELEE_ATTACKING                       = 57, Result: 1 if
    IS_RANGED_ATTACKING                      = 58, Result: 1 if
    HEALTH                                   = 59, Result:
    SPELL_KNOWN                              = 60, Result:
    HAS_HARMFUL_AURA_EFFECT                  = 61, Result:
